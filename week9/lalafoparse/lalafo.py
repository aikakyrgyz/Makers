...
def get_page_data(html):
    ...
    print(soup_main)
    all_articles = soup_main.find('div', class_="main-feed__container desktop css-9lcrl7")
    print(all_articles)
    # each_article = all_articles.find_all('div', class_="AdTileHorizontal")
    # print(each_article)
...
def main():
    ...
    site_url = 'https://lalafo.kg/kyrgyzstan/otdaem-darom'
